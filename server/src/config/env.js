...
/** Development only: if Mongo is unreachable, log and continue (API routes needing DB will error). */
export const DEV_ALLOW_DB_FAILURE =
  NODE_ENV === 'development' &&
  (process.env.DEV_ALLOW_DB_FAILURE === 'true' || process.env.DEV_ALLOW_DB_FAILURE === '1')
